...
def build_health_snapshot() -> dict[str, object]:
    ...
    return {
        ...
        "llm_provider_default": os.environ.get("APEX_LLM_PROVIDER", "").strip() or "anthropic",
...
def build_config_describe_snapshot() -> dict[str, object]:
    ...
    return {
        ...
        "environment": {
            "APEX_LLM_PROVIDER": os.environ.get("APEX_LLM_PROVIDER", "") or None,
            "APEX_USER_CONFIG_PATH": os.environ.get("APEX_USER_CONFIG_PATH", "") or None,
            "ANTHROPIC_API_KEY": "set" if ak.strip() else None,
